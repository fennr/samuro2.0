...
__all__ = ["SamuroContext", "SamuroSlashContext", "SamuroMessageContext", "SamuroUserContext", "SamuroPrefixContext"]

if t.TYPE_CHECKING:
    from .bot import SamuroBot
...
class SamuroContext(lightbulb.Context):
...
class SamuroSlashContext(SamuroContext, lightbulb.SlashContext):
    """Custom SlashContext for Samuro."""


class SamuroUserContext(SamuroContext, lightbulb.UserContext):
    """Custom UserContext for Samuro."""


class SamuroMessageContext(SamuroContext, lightbulb.MessageContext):
    """Custom MessageContext for Samuro."""


class SamuroPrefixContext(SamuroContext, lightbulb.PrefixContext):
    """Custom PrefixContext for Samuro."""
