...
class SamuroEvent(hikari.Event):
    """
...
class SamuroGuildEvent(SamuroEvent):
    """
...
@attr.define()
class TimerCompleteEvent(SamuroGuildEvent):
    """
...
@attr.define()
class MassBanEvent(SamuroGuildEvent):
    """
...
@attr.define()
class WarnEvent(SamuroGuildEvent):
    """
...
@attr.define()
class AutoModMessageFlagEvent(SamuroGuildEvent):
    """
...
@attr.define()
class RoleButtonEvent(SamuroGuildEvent):
    """
