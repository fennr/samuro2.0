...
async def miru_persistent(ctx: SamuroSlashContext) -> None:
...
@lightbulb.implements(lightbulb.SlashCommand)
async def viewtest(ctx: SamuroSlashContext) -> None:
    view = BasicView()
...
@lightbulb.implements(lightbulb.SlashCommand)
async def modaltest(ctx: SamuroSlashContext) -> None:
    modal = BasicModal()
...
@lightbulb.implements(lightbulb.SlashCommand)
async def navtest(ctx: SamuroSlashContext) -> None:
...
@lightbulb.implements(lightbulb.SlashCommand)
async def testmultiple_cmd(ctx: SamuroSlashContext) -> None:
...
@lightbulb.implements(lightbulb.SlashCommand)
async def test_cmd(ctx: SamuroSlashContext) -> None:
    text = ctx.options.text
    attribs = [
