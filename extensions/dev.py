...
async def run_shell(ctx: SamuroPrefixContext, code: str) -> None:
    """
...
async def reload_cmd(ctx: SamuroPrefixContext, extension_name: str) -> None:
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def load_cmd(ctx: SamuroPrefixContext, extension_name: str) -> None:
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def unload_cmd(ctx: SamuroPrefixContext, extension_name: str) -> None:
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def eval_py(ctx: SamuroPrefixContext, code: str) -> None:
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def eval_sh(ctx: SamuroPrefixContext, code: str) -> None:
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def dev_git_pull(ctx: SamuroPrefixContext, code: str) -> None:
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def resync_app_cmds(ctx: SamuroPrefixContext) -> None:
    await ctx.app.rest.trigger_typing(ctx.channel_id)
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def run_sql(ctx: SamuroPrefixContext) -> None:
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def backup_db_cmd(ctx: SamuroPrefixContext) -> None:
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def restore_db(ctx: SamuroPrefixContext) -> None:
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def blacklist_cmd(ctx: SamuroPrefixContext, mode: str, user: hikari.User) -> None:
...
@lightbulb.implements(lightbulb.PrefixCommand)
async def resetsettings_cmd(ctx: SamuroPrefixContext, guild_id: int) -> None:
